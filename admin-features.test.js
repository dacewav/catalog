...
import { showEt } from '../src/admin/nav.js';
...
describe('showEt', () => {
  ...
  it('toggles on class on matching tab and panel by index', () => {
    const tabs = [
    ...
    // 'lics' is index 1
    showEt('lics');
    expect(tabs[0].classList.toggle).toHaveBeenCalledWith('on', false);
    expect(tabs[1].classList.toggle).toHaveBeenCalledWith('on', true);
    expect(tabs[2].classList.toggle).toHaveBeenCalledWith('on', false);
    expect(panels[0].classList.toggle).toHaveBeenCalledWith('on', false);
    expect(panels[1].classList.toggle).toHaveBeenCalledWith('on', true);
    expect(panels[2].classList.toggle).toHaveBeenCalledWith('on', false);
